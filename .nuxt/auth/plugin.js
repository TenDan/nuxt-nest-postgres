...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"/login","method":"post","propertyName":"data.token"},"logout":false,"user":false},"tokenType":"Bearer","tokenName":"Authorization","autoFetchUser":false,"_name":"local"}))
